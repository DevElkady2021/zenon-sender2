            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                    <div class="d-flex align-items-center justify-content-center mb-3">
                        <img src="{{ asset('public/kadi-logo.png') }}" alt="Zenon">
                    </div>
                    <h3 class="text-center"> ! قم بتسجيل الدخول الان </h3>
                    <div class="list text-center my-3" >
                        <ul style="list-style: none">
                            <li class="p-2">علشان تتابع شحنتك بكل سهولة <i class="fa fa-check-circle"></i></li>
                            <li class="">      اسرع خدمة توصيل باقل سعر   <i class="fa fa-check-circle"></i></li>
                        </ul>
                    </div>
                    <div class="row text-center">
                        <div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12  mb-3">
                            <a href="{{ route('login') }}" class="btn btn-outline-info">تسجيل الدخول</a>
                        </div>
                        <div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12  mb-3">
                            <a href="{{ route('register') }}" class="btn btn-light">انشاء حساب جديد</a>
                           
                        </div>
                        <div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12  mb-3">
                            <a href="#" class="text-danger"> الدعم الفنى</a>
                        </div>
                    </div>
